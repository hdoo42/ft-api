...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let evaluators = [190844, 174141, 197483, 197459, 197606, 174081].map(FtUserId::new);
    ...
    let begin_at = Utc.with_ymd_and_hms(2025, 2, 11, 5, 0, 0).unwrap();
    ...
    let file_path = format!(
        "/Users/hdoo/works/gsia/codes/libft-api/libft-api/bin/piscine/third_cohort/first_round/rush_teams_{}.csv",
